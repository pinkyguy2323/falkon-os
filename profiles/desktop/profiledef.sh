#!/usr/bin/env bash
# Falkon OS - Desktop edition profiledef (classic window desktop: KDE Plasma)
# Совместимо с archiso v65+

iso_name="falkon-desktop"
iso_label="FALKON_DESKTOP_$(date +%Y%m)"
iso_publisher="Falkon OS <https://github.com/falkon-os>"
iso_application="Falkon OS Desktop - Arch-based"
...
file_permissions=(
  ...
  ["/usr/bin/falkon-welcome"]="0:0:755"
  ["/usr/bin/falkon-themes"]="0:0:755"
  ["/usr/bin/falkon-customizer"]="0:0:755"
  ["/usr/bin/falkon-install"]="0:0:755"
  ["/usr/bin/falkon-wallpaper"]="0:0:755"
